...
// Функция transformAnsArr не учитывающая размер текстовой строки (< 20 символов),
//  т.е. все значения, кроме 0,
//  переводятся в текстовый формат
...
//       console.log(arr);
//       ansNum1 = arr[0];
//       console.log(firstNums[ansNum1 - 1]);
//       return firstNums[ansNum1 - 1];
//     } else if (arr.length === 2 && arr[0] === 1) {
//       console.log(arr);
//       ansNum2 = arr[1];
//       console.log(secondNums[ansNum2 - 1]);
//       return secondNums[ansNum2 - 1];
//     } else if (arr.length === 2 && arr[1] === 0) {
//       console.log(arr);
//       ansNum1 = arr[0];
//       console.log(thirdNums[ansNum1 - 1]);
//       return thirdNums[ansNum1 - 1];
//     } else if (arr.length === 2) {
//       console.log(arr);
//       ansNum1 = arr[0];
//       ansNum2 = arr[1];
//       console.log(thirdNums[ansNum1 - 1] + ' ' + firstNums[ansNum2 - 1]);
...
//       console.log(arr);
//       ansNum1 = arr[0];
//       console.log(fourthNums[ansNum1 - 1]);
//       return fourthNums[ansNum1 - 1];
//     } else if (arr.length === 3 && arr[1] === 0 && arr[2] > 0) {
//       console.log(arr);
//       ansNum1 = arr[0];
//       ansNum3 = arr[2];
//       console.log(fourthNums[ansNum1 - 1] + ' ' + firstNums[ansNum3 - 1]);
...
//       ansNum2 = arr[1];
//       console.log(arr);
//       console.log(fourthNums[ansNum1 - 1] + ' ' + thirdNums[ansNum2 - 1]);
//       return fourthNums[ansNum1 - 1] + ' ' + thirdNums[ansNum2 - 1];
//     } else if (arr.length === 3 && arr[1] === 1 && arr[2] > 0) {
//       console.log(arr);
//       ansNum1 = arr[0];
//       ansNum3 = arr[2];
//       console.log(fourthNums[ansNum1 - 1] + secondNums[ansNum3 - 1]);
...
//       console.log(arr);
//       ansNum1 = arr[1];
//       console.log(`минус ${firstNums[ansNum1 - 1]}`);
//       return `минус ${firstNums[ansNum1 - 1]}`;
//     } else if (arr.length === 3 && arr[1] === 1) {
//       console.log(arr);
//       ansNum2 = arr[2];
//       console.log(`минус ${secondNums[ansNum2 - 1]}`);
//       return `минус ${secondNums[ansNum2 - 1]}`;
//     } else if (arr.length === 3 && arr[2] === 0) {
//       console.log(arr);
//       ansNum1 = arr[1];
//       console.log(`минус ${thirdNums[ansNum1 - 1]}`);
//       return `минус ${thirdNums[ansNum1 - 1]}`;
//     } else if (arr.length === 3) {
//       console.log(arr);
//       ansNum1 = arr[1];
//       ansNum2 = arr[2];
//       console.log(`минус ${thirdNums[ansNum1 - 1]} ${firstNums[ansNum2 - 1]}`);
...
//       ansNum3 = arr[3];
//       console.log(
//         `минус ${fourthNums[ansNum1 - 1]} ${thirdNums[ansNum2 - 1]} ${
//           firstNums[ansNum3 - 1]
//         }`
//       );
...
//       console.log(arr);
//       ansNum1 = arr[1];
//       console.log(`минус ${fourthNums[ansNum1 - 1]}`);
//       return `минус ${fourthNums[ansNum1 - 1]}`;
//     } else if (arr.length === 4 && arr[2] === 0 && arr[3] > 0) {
//       console.log(arr);
//       ansNum1 = arr[1];
//       ansNum3 = arr[3];
//       console.log(`минус ${fourthNums[ansNum1 - 1]} ${firstNums[ansNum3 - 1]}`);
...
//       ansNum2 = arr[2];
//       console.log(arr);
//       console.log(`минус ${fourthNums[ansNum1 - 1]} ${thirdNums[ansNum2 - 1]}`);
//       return `минус ${fourthNums[ansNum1 - 1]} ${thirdNums[ansNum2 - 1]}`;
//     } else if (arr.length === 4 && arr[2] === 1 && arr[3] > 0) {
//       console.log(arr);
//       ansNum1 = arr[1];
//       ansNum3 = arr[3];
//       console.log(
//         `минус ${fourthNums[ansNum1 - 1]} ${secondNums[ansNum3 - 1]}`
//       );
